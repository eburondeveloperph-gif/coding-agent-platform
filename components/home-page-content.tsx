...
import { getDefaultModelForAgent } from '@/lib/openmax/agents'
  ...
  const handleOpenRepoUrl = async (repoUrl: string) => {
    try {
      ...
      const taskData = {
        ...
        repoUrl: repoUrl,
        selectedAgent: localStorage.getItem('last-selected-agent') || 'codemax',
        selectedModel: localStorage.getItem('last-selected-model-codemax') || getDefaultModelForAgent('codemax'),
      ...
      <Dialog open={showSignInDialog} onOpenChange={setShowSignInDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>You need an account to create tasks.</DialogDescription>
          </DialogHeader>

          <div className="py-2">
            <EmailAuthForm onSuccess={() => setShowSignInDialog(false)} />
          </div>
        </DialogContent>
      </Dialog>
    </div>
